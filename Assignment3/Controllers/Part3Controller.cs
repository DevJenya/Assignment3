...
namespace Assignment3.Controllers
{
    public class Part3Controller : Controller
    {
        ...
        Item ram = new Item(0, 1, "Ram 1", 111.99, "~/Images/Part3/ram.jpg");
        Item harddrive = new Item(1, 2, "harddrive 1", 511.99, "~/Images/Part3/harddrive.jpg");
        Item cpu = new Item(2, 3, "Intel CPU", 671.99, "~/Images/Part3/ram.jpg");
        Item display = new Item(3, 4, "display", 511.99, "~/Images/Part3/ram.jpg");
        Item os = new Item(4, 5, "Operating System", 511.99, "~/Images/Part3/ram.jpg");
        Item soundcard = new Item(5, 6, "soundcard 11", 131.39, "~/Images/Part3/ram.jpg");
        Item ram2 = new Item(6, 1, "Ram 2 Big RAM", 221.99, "~/Images/Part3/ram.jpg");
        Item harddrive2 = new Item(7, 2, "MEGA harddrive 2 ", 211.99, "~/Images/Part3/harddrive.jpg");
        Item cpu2 = new Item(8, 3, "AMD CPU", 431.99, "~/Images/Part3/ram.jpg");
        Item display2 = new Item(9, 4, "display 2", 511.99, "~/Images/Part3/ram.jpg");
        Item os2 = new Item(10, 5, "Operating System 2", 511.99, "~/Images/Part3/ram.jpg");
        Item soundcard2 = new Item(11, 6, "soundcard 222", 777.99, "~/Images/Part3/ram.jpg");

        Computer_composit computer;
        Computer_composit computer2;
        Computer_composit computer3;

        public Part3Controller()
        {
            list_ram.Add(ram);
            ...
            computer = new Computer_composit(0, "Computer 1", 12345.99, ram, harddrive, cpu, display, os, soundcard, "~/Images/Part3/computer.png");
            computer2 = new Computer_composit(1, "Computer 2", 99945.99, ram, harddrive, cpu, display, os, soundcard, "~/Images/Part3/computer.png");
            computer3 = new Computer_composit(2, "Computer 3", 44445.99, ram2, harddrive2, cpu, display, os2, soundcard, "~/Images/Part3/computer.png");
        ...
        {
            return View("~/Views/Part3/About.cshtml");
        }
        ...
        public ActionResult ItemsList(string category) 
        {
            ...
            if (categ == 1)
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_ram);
            }
            else if (categ == 2)
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_harddrive);
            }
            else if (categ == 3)
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_cpu);
            }
            else if (categ == 4)
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_display);
            }
            else if (categ == 5)
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_os);
            }
            else // categ == 6
            {
                return View("~/Views/Part3/ItemsList.cshtml", list_soundcard);
            }
        ...
        public ActionResult ShowCompositeProduct(string i)
        {
            ...
            return View("~/Views/Part3/ViewCompositeProduct.cshtml", computer_list[index]);
        }
