    ...
    public class Part4Controller : Controller
    {
        ...
        public ActionResult CustomerOrders()
        {
            ...
            if (cookie != null)
            {
                ...
                List<Order> order_list = orderManagement.GetCustomerOrders(userID);
            
            return View("~/Views/Part4/OrderManagement/CustomerOrders.cshtml", order_list);
        }
        ...
        public ActionResult PurchaseItemsInCart()
        {
            //check if variable storing cart length exists 
            HttpCookie cookie = Request.Cookies["authorized"];
            int userID = 0;
            ...
            return View("PurchaseOrderView", list);
        }
